...
public class Adventure {
	public static void a(CanFigth x) {x.figth();}
	public static void b(CanSwim x) {x.swim();}
	public static void c(CanFly x) {x.fly();}
	public static void d(ActionCharacter x) {x.figth();}
...
interface CanFigth {void figth();}
interface CanSwim {void swim();}
interface CanFly {void fly();}
interface CanClimb {void climb();}
class ActionCharacter {public void figth() {System.out.println("ActionCharacter.figth");}}
