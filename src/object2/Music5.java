...
class Wind1 implements Instrument1 {
    ...
    public void adjust() {
        System.out.println("Wind1.adjust");
    }
}

class Percussion1 implements Instrument1 {
    public void play() {
        System.out.println("Percussion1.play");
    }

    public void adjust() {
        System.out.println("Percussion1.adjust");
    }
}

class Stringed1 implements Instrument1 {
    public void play() {
        System.out.println("Stringed1.play");
    }

    public void adjust() {
        System.out.println("Stringed1.adjust");
    }
}
...
class Woodwind1 extends Wind1 {
    ...
    public String what() {
        return "Woodwind1.what";
    }
}

class Brass1 extends Wind1 {
    public void play() {
        System.out.println("Brass1.play");
    }
